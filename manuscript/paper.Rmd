...
author: | 
  | \large Allison Ozark$^1$, Akhil Ghosh$^1$, Raheyma Siddiqui$^1$, Matthew Stuart$^1$,
  | \large  Samantha Swank$^1$, Michael A. Bell$^2$, Gregory J. Matthews$^1$, and Yoel E. Stuart$^1$ \vspace{-1.1mm}
  |
  | \large $^1$ Loyola University Chicago, Chicago, IL, USA \vspace{-1.1mm}
  |
  | \large $^2$ University of California Museum of Paleontology, Berkeley, CA, USA \vspace{-1.1mm}
  |
abstract: |
...
The fossil data consists of `r sum(is.na(stick$gender))` specimens with unknown sex over 18 time periods spaced  ~1000 years apart. Table 2 shows the sample size at each of the 18 time periods.  There are at least 22 specimens at each time period with a high of 67 specimens in period 7.  
