...
```{r echo = FALSE, tab.cap= "Posterior probability that the mean for male sis larger than the mean for females"}
...
```{r echo = FALSE, tab.cap= "AUC comparing time x versus time 0."}
...
```{r echo = FALSE, fig.cap = "Posterior probabilities that mean for males is greater than mean for females"}
...
```{r, echo = FALSE, fig.cap= "AUC comparing time x versus time 0."}
