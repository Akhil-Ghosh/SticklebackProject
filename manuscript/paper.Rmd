...
ggplot(aes(x = time, y = prob_mu_diff_gt_0), data = results_prob_mu_diff_gt_0) + facet_wrap(~phenotype) + geom_path() + geom_hline(yintercept = 0, lty = 3) + ylim(0,1) + ylab("Posterior Probability")
```
