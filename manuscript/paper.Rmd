...
We took the mean trait values for each sex at each temporal sample and quantified sexual dimorphism by \textcolor{red}{FILL IN THE METHODS HERE}

Recall that we predicted that sexual dimorphism should increase through time in Lineage II, following ecological release from predators. To test this prediction, we \textcolor{red}{FILL IN THE METHODS REGARDING TAU ANALYSES HERE}
