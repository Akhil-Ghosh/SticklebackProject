...
\title{~\Medium Increased sexual dimorphism does not evolve in a fossil
...
Abdominal Vertebra Count & mav & Number of vertebrae anterior to the
first vertebra contacting an anal fin pterygiophore (Aguirre et
al.~2014) \\
Caudal Vertebra Count & \texttt{mcv} & Number of vertebrae posterior to
and including the first vertebra contacting an anal fin pterygiophore
(Aguirre et al.~2014) \\
...
\textcolor{red}{THIS NEEDS MORE WORK TO JUSTIFY THE BAYESIAN APPROACH, EXPLAINING IT TO MY AUDIENCE. -YS}
